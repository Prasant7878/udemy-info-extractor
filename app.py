...
class Course:
    def __init__(self, course_dict):
        ...
        self.original_price = course_dict['original_price']
...
class UdemyInfoExtractor:
    ...
    def __init__(self, url):
        ...
        self.original_price = self.__scrape_with_regex('', self.page_source)
...
if __name__ == "__main__":
    a = UdemyInfoExtractor('https://www.udemy.com/course/excel-beginners/')
